...
/** \mainpage RoboComp::multi_room
 *
 * \section intro_sec Introduction
 *
 * The multi_room component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/multi_room --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "multi_room"
#define SERVER_FULL_NAME   "RoboComp multi_room::multi_room"
...
class multi_room : public Ice::Application
{
public:
	multi_room (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData multi_room::getInitializationDataIce(){
...
int multi_room::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	multi_room app(configFile, prefix, startup_check_flag);
