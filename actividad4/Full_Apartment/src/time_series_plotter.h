...
class TimeSeriesPlotter
{
    public:
        ...
        struct Config
        {
            QString title = "Time Series";      ///< Main title of the plot.
            QString xAxisLabel = "Time (s)";    ///< Label for the horizontal axis.
            QString yAxisLabel = "Value";       ///< Label for the vertical axis.
            ...
            Config() : title("Time Series"), xAxisLabel("Time (s)"), yAxisLabel("Value"), timeWindowSeconds(10.0),
            yMin(-10.0), yMax(10.0), autoScaleY(true) , showLegend(false), maxDataPoints(10000) {}
        };
