...
/** \mainpage RoboComp::full_apartment
 *
 * \section intro_sec Introduction
 *
 * The full_apartment component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/full_apartment --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "full_apartment"
#define SERVER_FULL_NAME   "RoboComp full_apartment::full_apartment"
...
class full_apartment : public Ice::Application
{
public:
	full_apartment (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData full_apartment::getInitializationDataIce(){
...
void full_apartment::initialize()
{
...
int full_apartment::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	full_apartment app(configFile, prefix, startup_check_flag);
